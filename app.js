...
function sendMessage(event) {
  if (event.keyCode === 13) {
    ...
    if (message !== "") {
      ...
      if (
        ["hi", "hey", "hello", "hy", "salam", "assalamalaikum"].indexOf(
          message.toLowerCase()
        ) !== -1
      ) {
        setTimeout(function () {
        ...
        ["courses", "course", "it course", "it courses"].indexOf(
          message.toLowerCase()
        ) !== -1
      ) {
        setTimeout(function () {
        ...
        setTimeout(function () {
          chatMsg.innerHTML += `<div>
                    <div class='bot-message d-inline-block'>Yes, we offer a Web and App course. Please stay connected with our <a href="https://www.facebook.com/saylani.smit/" class="">Saylani Facebook page</a> for application details.
                    <p>Modules Offered:</p>
                    <ul>
                    <li>HTML, CSS<br>
        ...
        ["ai courses", "ai course", "ai", "artificial intelligence"].indexOf(
          message.toLowerCase()
        ) !== -1
      ) {
        setTimeout(function () {
